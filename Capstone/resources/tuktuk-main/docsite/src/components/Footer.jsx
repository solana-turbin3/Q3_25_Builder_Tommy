...
export default function Footer({ noDivider = false }) {
  return (
    <footer className={`flex flex-col items-center justify-between gap-5 pt-4 dark:border-white/5 sm:flex-row ${!noDivider && 'mt-8 border-t border-zinc-900/5'}`}>
      <p className="text-xs text-zinc-600 dark:text-zinc-400">
        © Copyright {new Date().getFullYear()}. Helium Network.
      </p>
      <div className="flex justify-center gap-4 items-center flex-wrap">
        <Link className="group" href="https://twitter.com/helium">
        ...
        <Link className="group" href="https://github.com/helium/tuktuk">
        ...
        <Link className="group" href="https://discord.gg/helium">
